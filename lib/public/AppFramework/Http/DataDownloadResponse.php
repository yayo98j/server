 ...
 * @template-extends DownloadResponse<S, C, H>
 */
class DataDownloadResponse extends DownloadResponse {
	 ...
	 * @since 8.0.0
	 */
	public function __construct($data, $filename, $contentType, $statusCode = Http::STATUS_OK, $headers = []) {
		$this->data = $data;
		parent::__construct($filename, $contentType, $statusCode, $headers);
	}
