...
class TextPlainResponse extends Response {
	 ...
	 * @since 22.0.0
	 */
	public function __construct(string $text = '', int $statusCode = Http::STATUS_OK, $headers = []) {
		parent::__construct($statusCode, array_merge(['Content-Type' => 'text/plain'], $headers));
