...
class PreviewControllerTest extends \Test\TestCase {
	...
	public function testInvalidFile() {
		...
		$expected = new DataResponse(\stdClass::class, Http::STATUS_BAD_REQUEST);
	...
	public function testFileNotFound() {
		...
		$expected = new DataResponse(\stdClass::class, Http::STATUS_NOT_FOUND);
	...
	public function testForbiddenFile() {
		...
		$expected = new DataResponse(\stdClass::class, Http::STATUS_FORBIDDEN);
