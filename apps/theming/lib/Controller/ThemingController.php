...
class ThemingController extends Controller {
	 ...
	 * @return FileDisplayResponse<Http::STATUS_OK, string, array{Content-Disposition: non-falsy-string}>|NotFoundResponse<array{}>
	 * @throws NotPermittedException
	 *
	 * 200: Image returned
	 * 404: Image not found
	...
	public function getImage(string $key, bool $useSvg = true) {
		...
		$response = new FileDisplayResponse($file, Http::STATUS_OK, ['Content-Disposition' => 'attachment; filename="' . $key . '"'], $useSvg ? $this->config->getAppValue($this->appName, $key . 'Mime', '') : 'image/png');
	 ...
	 * @return DataDisplayResponse<Http::STATUS_OK, 'text/css', array{}>|NotFoundResponse<array{}>
	 *
	...
	public function getThemeStylesheet(string $themeId, bool $plain = false, bool $withCustomCss = false) {
		...
		try {
			$response = new DataDisplayResponse($css, Http::STATUS_OK, [], 'text/css');
	 ...
	 * @return JSONResponse<Http::STATUS_OK, array{name: string, short_name: string, start_url: string, theme_color: string, background_color: string, description: string, icons: array{src: string, type: string, sizes: string}[], display: string}, array{}>
	 */
