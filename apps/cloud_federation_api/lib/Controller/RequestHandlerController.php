...
class RequestHandlerController extends Controller {
	 ...
	 *
	 * @return JSONResponse<Http::STATUS_CREATED, list<mixed>, array{}>|JSONResponse<Http::STATUS_BAD_REQUEST|Http::STATUS_FORBIDDEN, CloudFederationApiValidationError, array{}>|JSONResponse<Http::STATUS_NOT_IMPLEMENTED, CloudFederationApiError, array{}>
